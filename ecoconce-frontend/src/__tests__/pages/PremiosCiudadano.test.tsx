...
describe("PremiosCiudadano Page Tests", () => {
  ...
  it("debe mostrar advertencia si el premio requiere envío y el usuario no tiene dirección", async () => {
    ...
    // Advertencia de envío a domicilio debe mostrarse
    expect(screen.getByText("Este premio requiere envío a domicilio.")).toBeInTheDocument();
    expect(screen.getByText("Completa tu dirección en el perfil antes de canjearlo.")).toBeInTheDocument();
