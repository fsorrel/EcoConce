...
export function CitizenDashboard() {
  ...
  const { data: dashboard, loading: dashboardLoading, error: dashboardError } = useDashboard(getDemoUserId());
  ...
  return (
    <div className="p-8 space-y-8 bg-[#f5f7f5] min-h-screen">
      ...
      {dashboardError && <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-700">{dashboardError}</div>}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {dashboardLoading ? (
          Array.from({ length: 4 }).map((_, idx) => (
            <Card key={idx} className="border-[#6fae7f]/20">
              <CardContent className="p-6">
          ...
          stats.map((stat) => {
            ...
            return (
              <Card key={stat.label} className="border-[#6fae7f]/20 hover:shadow-lg transition">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="border-[#6fae7f]/20">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {dashboardLoading ? (
                  Array.from({ length: 4 }).map((_, idx) => (
                    <div key={idx} className="p-4 rounded-xl border border-gray-200 bg-gray-50/50 space-y-3 text-center animate-pulse">
          ...
          <Card className="border-[#6fae7f]/20">
            ...
            <CardContent className="grid md:grid-cols-2 gap-4">
              {dashboardLoading ? (
                Array.from({ length: 4 }).map((_, idx) => (
                  <div key={idx} className="p-4 bg-white rounded-lg border border-[#6fae7f]/20 space-y-2 animate-pulse">
            ...
            <CardContent className="space-y-4">
              {dashboardLoading ? (
                Array.from({ length: 3 }).map((_, idx) => (
                  <div key={idx} className="p-4 bg-[#f5f7f5] rounded-lg space-y-3 animate-pulse">
                    <div className="flex justify-between">
